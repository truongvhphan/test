...
<?php
    foreach($rsAdmins as $admin){
		...
		echo ' <a href="../Controllers/Administrators_controller.php?action=edit_pass" data-toggle="modal" data-target="#myModal' . $admin->adminID . '">Đổi Password</a></td>';
        echo '</tr>';
?>
        <!-- Modal Mỗi record administrator sẽ có 1 modal riêng, nên để vô vòng lặp-->
  <div class="modal fade" id="myModal<?php echo $admin->adminID;?>" role="dialog">
